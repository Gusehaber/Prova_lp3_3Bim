...
import Auxiliar.*;
// @author Radames
public class VendaGUIListagem extends JDialog {

    JPanel painelTa = new JPanel();
    static DefaultTableModel modelo = new DefaultTableModel(new String[]{"ID Venda","Data"}, 0);
    static JTable tabela = new JTable(modelo);
    JScrollPane scroll = new JScrollPane(tabela);
    List<String> lista = new ArrayList<>();
    public VendaGUIListagem(List<String> texto, Container cp2) {
    ...
    public void atualizaTabela() {
        DefaultTableModel modelo = new DefaultTableModel(new String[]{"ID Venda","Data"}, 0);
        int aux = 0;
