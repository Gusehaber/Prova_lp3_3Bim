...
public class GUIMarca extends JFrame {
    ...
    private JLabel lbIdMarca = new JLabel("ID");
    private JTextField fdIdMarca = new JTextField(10);

    private JLabel lbNomeMarca = new JLabel("Nome");
    private JTextField fdNomeMarca = new JTextField(45);
    ...
    DAOMarca controle = new DAOMarca();
    ...
    public GUIMarca(){
        ...
        painelCentral.add(lbNomeMarca);
        painelCentral.add(fdNomeMarca);

        fdNomeMarca.setEnabled(false);
...
cp.setBackground(Color.white);
        ...
        fdIdMarca.setFont(new Font("Courier New", Font.PLAIN, 20));
        lbIdMarca.setFont(new Font("Courier New", Font.BOLD, 17));
        lbNomeMarca.setFont(new Font("Courier New", Font.BOLD, 17));
        fdIdMarca.setFont(new Font("Courier New", Font.PLAIN, 17));
        fdNomeMarca.setFont(new Font("Courier New", Font.PLAIN, 17));
        ...
        btBuscar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try{
                    marca = new Marca();
                    int idMarca = Integer.valueOf(fdIdMarca.getText());
                    marca.setIdMarca(Integer.valueOf(fdIdMarca.getText()));
                    marca = controle.obter(marca.getIdMarca());
                    labelAviso.setBackground(Color.green);
                    if (marca != null) {
                        fdIdMarca.setText(marca.getIdMarca() + "");
                        fdNomeMarca.setText(marca.getNomeMarca() + "");
        ...
        btInserir.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                acao = true;
                fdIdMarca.setEnabled(false);
                fdNomeMarca.setEnabled(true);
        ...
        btSalvar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if(acao){ //btInserir
                    ...
                    marca = new Marca();
                        marca.setIdMarca(Integer.valueOf(fdIdMarca.getText()));
                        marca.setNomeMarca(fdNomeMarca.getText());
                        controle.inserir(marca);
                        labelAviso.setText("Registro inserido com sucesso!");
                        fdIdMarca.setEnabled(true);
                        fdIdMarca.requestFocus();
                        fdNomeMarca.setEnabled(false);
                        btSalvar.setVisible(false);
                        btCancelar.setVisible(false);
        ...
        btRemover.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                btListar.setVisible(false);
                btAtualizar.setVisible(false);
                if (JOptionPane.YES_OPTION == JOptionPane.showConfirmDialog(null, "Confirma a exclusão do registro <Chave = " + marca.getIdMarca() + " >?", "Confirm", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE)) {
                    controle.remover(marca);
        ...
        btListar.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                new MarcaGUIListagem(controle.listInOrderNomeStrings("tanto faz"), cp);
            }
        }
        );
