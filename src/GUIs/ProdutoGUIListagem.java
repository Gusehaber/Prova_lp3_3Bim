...
import Auxiliar.*;
// @author Radames
public class ProdutoGUIListagem extends JDialog {

    JPanel painelTa = new JPanel();
    static DefaultTableModel modelo = new DefaultTableModel(new String[]{"ID","Nome","Quantidade","Preco","TXTs"}, 0);
    static JTable tabela = new JTable(modelo);
    JScrollPane scroll = new JScrollPane(tabela);
    List<String> lista = new ArrayList<>();
    public ProdutoGUIListagem(List<String> texto, Container cp2) {
    ...
    public void atualizaTabela() {
        DefaultTableModel modelo = new DefaultTableModel(new String[]{"ID","Nome","Quantidade","Preco","TXTs"}, 0);
        int aux = 0;
